...
:material-office-building-outline: &nbsp; **Director - Data Analytics & AI — Novartis**

- Enterprise-wide AI adoption strategy
- Leading diverse international cross-functional teams
- Implementing AI solutions in manufacturing and engineering
- End-to-end digital transformation project management
...
:material-account-group-outline: &nbsp; **Leadership**
...
:material-function-variant: &nbsp; **Mathematical Gnostics**

- Non-statistical AI frameworks
...
[Explore Machine Gnostics :material-arrow-right:](ai-mg.md){ .md-button .md-button--primary }

---

<div class="profile-quote" markdown>

*"Transforming organisations through intelligent AI adoption — combining rigorous scientific methodology with innovative engineering solutions."*
